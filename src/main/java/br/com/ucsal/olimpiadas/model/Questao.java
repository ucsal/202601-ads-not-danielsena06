...
/**
 * SRP — representa apenas os dados e regras internas de uma questão
 *       (validação de alternativas, verificação de resposta correta).
 */
public class Questao {
    ...
    public void setFenInicial(String fen) {
         this.fenInicial = fen; 
    }
